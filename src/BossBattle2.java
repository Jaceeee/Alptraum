...
public class BossBattle2 extends BasicGameState {
    ...
    public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
        ...
        bossBattleMap = new Image("res/Mount-Bloom.png");
    ...
    public void update(GameContainer gc, StateBasedGame sbg, int delta) throws SlickException {
        ...
        if(launched){
            ...
            if(shotBounds.intersects(player2)){
                enemyOrb.subtractHP();
                launched = false;
                System.out.println(enemyOrb.getHp());
            }
        }
        ...
        if(enemyOrb.getHp() <= 0){
            ...
            sbg.enterState(4,new FadeOutTransition(Color.white,3000), new FadeInTransition(Color.white,3000));
        }
